  ...
  <div class="flex-1 overflow-y-auto panel-scroll">
    <div class="p-5 space-y-5">
      ...
      <div>
        ...
        <div class="space-y-2">
          {#each [{ label: 'B2G', status: guide.b2g }, { label: 'B2B', status: guide.b2b }, { label: 'B2C', status: guide.b2c }] as item}
            <div class="flex items-center justify-between px-3 py-2 rounded-lg" style="border: 1px solid #141435;">
              <span class="text-sm text-paleblue">{item.label}</span>
              <span class="text-sm font-medium" style="color: {getComplianceColor(item.status)};">
